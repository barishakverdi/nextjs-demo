                            ...
                            <div className="w-1/2 lg:w-full">
                                <div className="flex flex-col gap-[24px]">
                                    ...
                                    <div className="flex flex-col gap-[10px]">
                                        <h4 className="text-[36px] leading-[42px] tracking-[-1.08px] text-black-400">{ceo.name}</h4>
                                        <span className="text-[18px] leading-[38px] tracking-[-0.54px] text-gray-400">{ceo.position}</span>
                                    </div>
                                </div>
                            </div>
