    ...
    return (
        <RevealList interval={100} delay={500} reset={false} >
            <section className="mb-[60px] lg:mb-[30px]">
                <div className="py-[60px] lg:py-[30px] bg-light-200 dark:bg-black-300">
                    <div className="container mx-auto px-5">
                        <div className="px-[260px] xl:px-[130px] lg:px-[60px] md:px-0">
                            <h3 className="text-[48px] leading-[54px] tracking-[-1.44px] text-black-300 dark:text-light-200 xl:text-[38px] xl:leading-[44px] sm:text-[28px] sm:leading-[34px] mb-[40px] lg:mb-[30px]">Ready to apply?</h3>
