                ...
                <div className="container mx-auto px-5">
                    <div className="flex flex-col gap-[60px] lg:gap-[30px]">
                        <div className="flex flex-col gap-[24px]">
                            <h1 className="font-['Clash_Grotesk'] text-[74px] leading-[78px] tracking-[-2.22px] text-black-400 xl:text-[54px] xl:leading-[58px] sm:text-[44px] sm:leading-[48px]">{mainTitle}</h1>
