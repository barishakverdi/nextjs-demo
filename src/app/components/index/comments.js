            ...
            <section className="mb-[160px] max-xl:mb-[80px] max-lg:mb-[50px]">
                <div className="container mx-auto px-5">
                    <div className="relative">
                        <h2 className="whitespace-pre-line text-[60px] leading-[74px] max-lg:text-[50px] max-lg:leading-[64px] max-sm:text-[34px] max-sm:leading-[44px] text-black-400 dark:text-white tracking-[-1.8px] mb-[60px]">{title ? title : "What did \n" + "Our Customers Say?"}</h2>
                        <Swiper
                            ...
                            {customers.map((customer, index)=> (
                                <SwiperSlide key={index} className="group">
                                    <div className="p-[14px_24px] rounded-[48px] border-black-400 dark:border-white border borer-solid w-full opacity-40 transition-all duration-700 ease-in-out group-[&.swiper-slide-active]:opacity-100">
                                        <div className="flex items-center gap-[14px] max-lg:items-start">
                                            ...
                                            <div className="flex flex-col gap-[8px]">
                                                <p className="text-[18px] leading-[18px] max-lg:text-[16px] max-lg:leading-[34px tracking-[-0.54px] text-black-300 dark:text-light-300">{customer.title}, {customer.position}</p>
                                                <div className="flex items-center gap-[8px]">
                                                    <p className="text-[18px] leading-[38px] max-lg:text-[16px] max-lg:leading-[34px] tracking-[-0.54px] text-gray-400 dark:text-light-400 line-clamp-1 max-w-[970px] max-lg:line-clamp-none max-sm:line-clamp-3">{customer.comment}</p>
                                                    <div className="group/read">
                                                        <span className="whitespace-pre text-[18px] leading-[38px] tracking-[-0.54px] text-black-400 dark:text-white cursor-pointer max-lg:hidden flex flex-col after:w-0 after:h-[1px] after:bg-black-400 hover:after:w-full after:transition-all after:duration-300 after:ease-in-out">Read More</span>
