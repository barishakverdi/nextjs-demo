...
export default function LogoSlider({logo}) {
    ...
    for (let i = 1; i <= logoCount; i++) {
        logos.push(
            <SwiperSlide key={i} className="transition-all duration-300 ease-in-out lg:grayscale-0 grayscale hover:grayscale-0 hover:transition-all hover:ease-in-out hover:duration-300">
