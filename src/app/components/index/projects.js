        ...
        <RevealList interval={100} delay={500} reset={true} >
            <section className="my-[160px] xl:my-[80px] lg:my-[50px]">
                <div className="container mx-auto px-5 [&_.swiper]:[overflow:revert]">
                    <h2 className="text-[60px] leading-[74px] lg:text-[50px] lg:leading-[64px] sm:text-[34px] sm:leading-[44px] text-black-400 dark:text-white tracking-[-1.8px] mb-[50px]">{title ? title : "Latest Projects"}</h2>
                    <Swiper
                                ...
                                <div className="flex flex-col rounded-main overflow-hidden group">
                                    ...
                                    <div className="p-[16px_22px]">
                                        <a href={project.url} className="flex items-center justify-between gap-[12px]">
                                            <h4 className="text-[36px] leading-[42px] tracking-[-1.08px] text-black-300 dark:text-light-200 md:text-[26px] md:leading-[32px] after:w-0 after:h-[1px] after:bg-black-300 after:dark:bg-light-200 flex flex-col group-hover:after:w-full after:transition-all after:duration-300 after:ease-in-out">{project.title}</h4>
