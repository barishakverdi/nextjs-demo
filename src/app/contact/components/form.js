        ...
        <RevealList interval={100} delay={500} reset={false} >
            <section className="mb-[120px] lg:mb-[50px]">
                ...
                <div className="container mx-auto px-5">
                    <h2 className="px-[260px] xl:px-[130px] lg:px-[60px] md:px-0 text-[48px] leading-[54px] tracking-[-1.44px] text-black-300 dark:text-light-200 xl:text-[38px] xl:leading-[44px] sm:text-[28px] sm:leading-[34px] mb-[40px] sm:mb-[24px]">Let’s Chat.</h2>
