...
export default function Customers() {
    ...
    for (let i = 1; i <= 27; i++) {
        logos.push(
            <div key={i} className="flex justify-center items-center min-h-[100px] p-[12px_25px] lg:p-[16px] transition-all duration-300 ease-in-out lg:grayscale-0 lg:dark:grayscale grayscale hover:dark:grayscale hover:grayscale-0 hover:transition-all hover:ease-in-out hover:duration-300 [&_img]:dark:invert">
